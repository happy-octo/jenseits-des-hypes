...
extract_agent = Agent(
    model=Ollama(id="sroecker/nuextract-tiny-v1.5", host="localhost:11435"),
...
response: RunResponse = extract_agent.run(predict_nuextract(case1))

result = json_to_dict(response.content)
